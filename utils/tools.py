...
def fast_process(annotations, args, mask_random_color, bbox=None, points=None, edgs=False):
    ...
    if args.device == 'cpu':
        ...
        fast_show_mask(annotations,
                       plt.gca(),
                       random_color=mask_random_color, bbox=bbox,
                       points=points,
...
#   CPU post process
def fast_show_mask(annotation, ax, random_color=False, bbox=None, points=None, pointlabel=None, retinamask=True,
                   target_height=960, target_width=960):
...
def fast_show_mask_gpu(annotation, ax, random_color=False, bbox=None, points=None, pointlabel=None, retinamask=True,
                       target_height=960, target_width=960):
    msak_sum = annotation.shape[0]
    height = annotation.shape[1]
    weight = annotation.shape[2]
